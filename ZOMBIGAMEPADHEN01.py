...
class GameApp:
    ...
    def update(self):
        ...
        # 画面遷移用の入力判定 (新しいゲームパッド割り当てを使用)
        # SPACE/ENTER (KEY_RETURN) の代わりに、ご提示のコードに合わせて A/START/RETURN に変更
    ...
    def draw_credits_roll(self):
        ...
        if self.show_final_score:
            s_y = WINDOW_H // 2 - 20
            pyxel.text(center_text_x("--- FINAL SCORE ---"), s_y, "--- FINAL SCORE ---", 11)
